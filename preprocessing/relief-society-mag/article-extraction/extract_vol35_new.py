#!/usr/bin/env python3
"""
Extraction script for Relief Society Magazine Volume 35 (1948).
...
Usage:
    python extract_vol35_new.py
    python extract_vol35_new.py --dry-run
"""
...
VOL35_TOC = {
    ("Vol35", "No1_January_1948"): [
        ...
        {"title": "Pioneer Women", "author": "President David O. McKay", "etype": "article"},
        {"title": "Award Winners Eliza Roxey Snow Memorial Prize Poem Contest", "author": None, "etype": "article"},
        {"title": "A Decade of Doing", "author": "Dorothy Ducas", "etype": "article"},
        {"title": "How to Cover an Umbrella", "author": "Bertha Zaugg Perschon", "etype": "article"},
        {"title": "Three Mexican Dishes", "author": "Sara Mills", "etype": "article"},
        ...
        {"title": "Nugget of Truth", "author": "Alice Morrey Bailey", "etype": "fiction"},
        {"title": "Miss Libby Steps Out", "author": "Olive W. Burt", "etype": "fiction"},
        {"title": "Where Trails Run Out", "author": "Anna Prince Redd", "etype": "fiction"},
        {"title": "The Cherry Orchard", "author": "Katherine Fernelius Larsen", "etype": "poem"},
        {"title": "Migrant", "author": "Alice Morrey Bailey", "etype": "poem"},
        {"title": "The Young War Widow Speaks", "author": "Ruby Baird Andersen", "etype": "poem"},
        {"title": "Snow Upon the Earth", "author": "Christie Lund Coles", "etype": "poem"},
        ...
        {"title": "My Wealth", "author": "Della Adams Leitner", "etype": "poem"},
        {"title": "Theology: \u201cHonored by Strangers, Rejected by His Own\u201d", "author": "Don B. Colton", "etype": "lesson"},
    ...
    ("Vol35", "No2_February_1948"): [
        {"title": "Abraham Lincoln", "author": None, "etype": "article"},
        ...
        {"title": "Collecting Antique Chairs", "author": "Elizabeth Williamson", "etype": "article"},
        {"title": "Sixty Years Ago", "author": None, "etype": "article"},
        {"title": "Woman\u2019s Sphere", "author": "Ramona W. Cannon", "etype": "article"},
        ...
        {"title": "The Answer", "author": "Janath Russell Cannon", "etype": "fiction"},
        {"title": "Windy Hilltop", "author": "Ezra J. Poulsen", "etype": "fiction"},
        {"title": "The Parking Lot", "author": None, "etype": "fiction"},
        {"title": "Home Fires", "author": "Grace Sayre", "etype": "poem"},
        {"title": "February", "author": "Ora Pate Stewart", "etype": "poem"},
        {"title": "Too Frail a Lute", "author": "Eva Willes Wangsgaard", "etype": "poem"},
        {"title": "Theology: \u201cLord of the Sabbath\u201d; \u201cThe Chosen Twelve\u201d", "author": "Don B. Colton", "etype": "lesson"},
        {"title": "Visiting Teachers Messages: Beautification", "author": "Amy Brown Lyman", "etype": "lesson"},
        {"title": "Work Meeting Sewing: Lesson 7 Plackets and Zippers", "author": "Jean Ridges Jennings", "etype": "lesson"},
        {"title": "Work Meeting Sewing: Lesson 8 Make-Overs", "author": "Jean Ridges Jennings", "etype": "lesson"},
        {"title": "Literature: Appreciation Values in Doctrine and Covenants Reading", "author": "H. Wayne Driggs", "etype": "lesson"},
        {"title": "Social Science", "author": "Joseph Jacobs", "etype": "lesson"},
    ],
    ...
    ("Vol35", "No3_March_1948"): [
        ...
        {"title": "Mormonism in the Eyes of the Press IV", "author": "James R. Clark", "etype": "article"},
        {"title": "Sixty Years Ago", "author": None, "etype": "article"},
        {"title": "Woman\u2019s Sphere", "author": "Ramona W. Cannon", "etype": "article"},
        ...
        {"title": "Our Children\u2019s Children", "author": "Myrtle M. Dean", "etype": "fiction"},
        {"title": "The Visitors", "author": "Fay Tarlock", "etype": "fiction"},
        {"title": "Pankapaw", "author": "Deone R. Sutherland", "etype": "fiction"},
        {"title": "Windy Hilltop", "author": "Ezra J. Poulsen", "etype": "fiction"},
        {"title": "Spring Dusk", "author": "Christie Lund Coles", "etype": "poem"},
        ...
        {"title": "Something Is Glad", "author": "Dorothy J. Roberts", "etype": "poem"},
    ],

    ("Vol35", "No4_April_1948"): [
        {"title": "Jesus Christ, Our Lord", "author": "Don B. Colton", "etype": "article"},
        {"title": "Relief Society Building News", "author": None, "etype": "article"},
        {"title": "Sixty Years Ago", "author": None, "etype": "article"},
        {"title": "Woman\u2019s Sphere", "author": "Ramona W. Cannon", "etype": "article"},
        ...
        {"title": "Questing Lights", "author": "Belle Watson Anderson", "etype": "fiction"},
        {"title": "Windy Hilltop", "author": "Ezra J. Poulsen", "etype": "fiction"},
        ...
        {"title": "For Long Remembering", "author": "Berta H. Christensen", "etype": "poem"},
        ...
        {"title": "A Simile", "author": "Loie M. Beach", "etype": "poem"},
    ...
    ("Vol35", "No5_May_1948"): [
        ...
        {"title": "Questing Lights", "author": "Belle Watson Anderson", "etype": "fiction"},
        {"title": "Lullaby", "author": "Margery S. Stewart", "etype": "poem"},
    ...
    ("Vol35", "No6_June_1948"): [
        {"title": "Women and Narcotics", "author": "Joseph F. Merrill", "etype": "article"},
        ...
        {"title": "Petals and Wings", "author": "Eva Willes Wangsgaard", "etype": "poem"},
        ...
        {"title": "Song for a Daughter", "author": "Margery S. Stewart", "etype": "poem"},
    ],

    ("Vol35", "No7_July_1948"): [
        {"title": "The Women of the Mormon Battalion", "author": "Amy Brown Lyman", "etype": "article"},
        {"title": "Relief Society Building News", "author": None, "etype": "article"},
        ...
        {"title": "Hillside Grain Field", "author": "Eva Willes Wangsgaard", "etype": "poem"},
        ...
        {"title": "Beauty", "author": "Caroline Eyring Miner", "etype": "poem"},
        {"title": "Theology: The Sermon on the Mount", "author": "Don B. Colton", "etype": "lesson"},
        {"title": "Visiting Teachers\u2019 Messages: Ye Shall Do the Work Which Ye See Me Do", "author": "H. Wayne Driggs", "etype": "lesson"},
        {"title": "Literature: Literature of the Beginnings", "author": None, "etype": "lesson"},
        {"title": "Work Meeting Sewing: Suggestions for Changing Skirt Lengths", "author": "Jean Ridges Jennings", "etype": "lesson"},
        {"title": "Social Science: The Meaning and Importance of Political Doctrines", "author": "G. Homer Durham", "etype": "lesson"},
        {"title": "Optional Lessons in Lieu of Social Science: The Presidency of the Prophet Joseph Smith", "author": "T. Edgar Lyon", "etype": "lesson"},
    ],

    ("Vol35", "No8_August_1948"): [
        {"title": "Planning to Provide a Year\u2019s Supply", "author": "Mark B. Garff and Gertrude R. Garff", "etype": "article"},
        ...
        {"title": "Summer Day", "author": "Beatrice K. Ekman", "etype": "poem"},
        ...
        {"title": "Theology: As One Having Authority", "author": "Don B. Colton", "etype": "lesson"},
        {"title": "Visiting Teachers\u2019 Messages: Where Are the Nine?", "author": "H. Wayne Driggs", "etype": "lesson"},
        {"title": "Work Meeting Sewing: Remodeling Dresses", "author": "Jean Ridges Jennings", "etype": "lesson"},
        {"title": "Literature: Highlights of the Book of Mormon Epic", "author": "Howard R. Driggs", "etype": "lesson"},
        {"title": "Social Science: Some Political Doctrines of the Book of Mormon", "author": "G. Homer Durham", "etype": "lesson"},
        {"title": "Optional Lessons in Lieu of Social Science: The Presidency of the Prophet Joseph Smith (Continued)", "author": "T. Edgar Lyon", "etype": "lesson"},
    ],
    ...
    ("Vol35", "No9_September_1948"): [
        ...
        {"title": "Sixty Years Ago", "author": None, "etype": "article"},
        {"title": "Woman\u2019s Sphere", "author": "Ramona W. Cannon", "etype": "article"},
        {"title": "All Relief Society Members Invited to Thursday, September 30th Sessions", "author": None, "etype": "article"},
        ...
        {"title": "Something in Your Word", "author": "Dorothy J. Roberts", "etype": "poem"},
        ...
        {"title": "Between Friends", "author": "Mabel Jones Gabbott", "etype": "poem"},
        {"title": "Theology: He Spake Many Things Unto Them in Parables", "author": "Don B. Colton", "etype": "lesson"},
        {"title": "Visiting Teachers\u2019 Messages: Inasmuch As Ye Have Done It Unto One of These My Brethren", "author": "H. Wayne Driggs", "etype": "lesson"},
        {"title": "Work Meeting Sewing: Making Women\u2019s Wear From Men\u2019s Wear", "author": "Jean Ridges Jennings", "etype": "lesson"},
        {"title": "Literature: Gospel Messages From the Book of Mormon", "author": "Howard R. Driggs", "etype": "lesson"},
    ],
    ...
    ("Vol35", "No10_October_1948"): [
        ...
        {"title": "Epilogue", "author": "Beatrice K. Ekman", "etype": "poem"},
        {"title": "Cycle", "author": "Grace M. Candland", "etype": "poem"},
        ...
        {"title": "Walk With Me", "author": "Evelyn Fjeldsted", "etype": "poem"},
        {"title": "Night", "author": "Marijane Morris", "etype": "poem"},
        {"title": "Theology: Peace Be Still", "author": "Don B. Colton", "etype": "lesson"},
        {"title": "Visiting Teachers\u2019 Messages: In the World Ye Shall Have Tribulation: But Be of Good Cheer", "author": "H. Wayne Driggs", "etype": "lesson"},
        {"title": "Work Meeting Sewing: Salvage From Shirts", "author": "Jean Ridges Jennings", "etype": "lesson"},
        {"title": "Literature: Words of Light and Truth From the Prophet", "author": "Howard R. Driggs", "etype": "lesson"},
        {"title": "Social Science: Political Ideas Advocated by the Prophet Joseph Smith", "author": "G. Homer Durham", "etype": "lesson"},
        {"title": "Optional Lessons in Lieu of Social Science: The Presidency of Brigham Young", "author": "T. Edgar Lyon", "etype": "lesson"},
    ],

    ("Vol35", "No11_November_1948"): [
        {"title": "Joy in Full Measure", "author": "Belle S. Spafford", "etype": "article"},
        {"title": "And What of the Promise?", "author": "Marianne C. Sharp", "etype": "article"},
        {"title": "Relief Society Building News", "author": None, "etype": "article"},
        ...
        {"title": "Seasoning", "author": "Margery S. Stewart", "etype": "fiction"},
        ...
        {"title": "November Noon", "author": "Christie Lund Coles", "etype": "poem"},
        ...
        {"title": "Preface to Winter", "author": "Jessie M. Robinson", "etype": "poem"},
        {"title": "Simple Things of Life", "author": "Geneva I. Oldroyd", "etype": "poem"},
        {"title": "Spot", "author": "Eunice J. Miles", "etype": "poem"},
        {"title": "I Wait", "author": "Beatrice K. Ekman", "etype": "poem"},
        {"title": "I Wait for Spring", "author": "Grace Sayre", "etype": "poem"},
        {"title": "Desert Dusk", "author": "Grace Zenor Pratt", "etype": "poem"},
        {"title": "Hilltop Communion", "author": "Ruth Harwood", "etype": "poem"},
    ],

    ("Vol35", "No12_December_1948"): [
        {"title": "Living to Enjoy the Blessings of the Lord", "author": "George Albert Smith", "etype": "article"},
        {"title": "Relief Society Building News", "author": None, "etype": "article"},
        ...
        {"title": "Notes From the Field", "author": "Margaret C. Pickering", "etype": "article"},
        {"title": "From Near and Far", "author": None, "etype": "article"},
        {"title": "Aprons for Christmas", "author": "Alice Willardson", "etype": "article"},
        {"title": "Christmas Presents Can Be Different", "author": "Elizabeth Williamson", "etype": "article"},
        {"title": "Christmas Letter", "author": "Grace Rushton Squire", "etype": "article"},
        ...
        {"title": "The Christmas Dream", "author": "Christie Lund Coles", "etype": "poem"},
        {"title": "Ring Out, Ye Bells", "author": "Ruth May Fox", "etype": "poem"},
        {"title": "Winter", "author": "Alice R. Rich", "etype": "poem"},
        {"title": "One Lone Star", "author": "Dorothy J. Roberts", "etype": "poem"},
        {"title": "Music", "author": "C. Cameron Johns", "etype": "poem"},
        {"title": "We Pray", "author": "Alice Morrey Bailey", "etype": "poem"},
        {"title": "Miracle of Giving", "author": "Ruth Harwood", "etype": "poem"},
        {"title": "Theology: A Period of Darkening Opposition", "author": "Don B. Colton", "etype": "lesson"},
        {"title": "Visiting Teachers Messages: Ye Cannot Serve God and Mammon", "author": "H. Wayne Driggs", "etype": "lesson"},
        {"title": "Work Meeting Sewing", "author": "Jean Ridges Jennings", "etype": "lesson"},
        {"title": "Literature: Literature of the Restoration", "author": "Howard Driggs", "etype": "lesson"},
        {"title": "Social Science: Main Currents in Latter-day Saint Political Thought", "author": "G. Homer Durham", "etype": "lesson"},
        {"title": "Optional Lessons in Lieu of Social Science: The Presidency of John Taylor", "author": "T. Edgar Lyon", "etype": "lesson"},
    ],
}
...
for no in range(1, 13):
    ...
    key = f"No{no}_{month}_{year}"  # No zero-padding!
    fname = f"vol35_{key}.txt"  # lowercase vol!
...
# ---------------------------------------------------------------------------
# Known OCR-mangled section headers for Vol35.
# ---------------------------------------------------------------------------
# Serial fiction chapter patterns

# Serial fiction: Questing Lights (Chapters 4-9, Jul-Dec 1948)
# Earlier chapters (Apr-Jun) have no chapter numbers in the TOC — treated as
# standalone entries matching by title.
# In body text, the title and chapter number may be SEPARATED:
#   - Running headers: "QUESTING LIGHTS" (no chapter number)
#   - Chapter starts: "CHAPTER N Synopsis:" or "Belle Watson Anderson CHAPTER N"
# Match by author byline + CHAPTER N, or standalone CHAPTER N with Synopsis.
_QUESTING_LIGHTS_PAT = (
    r"(?:"
    r"Questing\s+Lights"
    r".{0,80}?"
    r"(?:(?:CHAPTER|Chapter|CuapTer)\s+)?"
    r"|"
    r"Belle\s+Watson\s+Anderson"
    r"[\s\S]{0,30}?"
    r"(?:CHAPTER|Chapter|CuapTer)\s+"
    r"|"
...
_KNOWN_HEADER_PATTERNS = {
    # Body has: Sheology—Lesson NN—SUBTITLE or THEOLOGY ... Lesson NN—SUBTITLE
    ...
    # Visiting Teacher Messages (no apostrophe variant)
    ...
    # Visiting Teachers' Messages (vol35 style, with apostrophe)
    "Visiting Teachers\u2019 Messages: ": (
        r"(?:V|U|\()?(?:i|s|u)?s?iting\s+"
        r"(?:(?:T|S|C|l|SJ)(?:e|l|a|J)?(?:a|e|c)?(?:ch|l!|h)?(?:er)?s?|Seal!?\s*Hes?)\s*"
        r"['\u2019]?\s*"
        r"(?:M|N|IT|T|m|He|HeIT)\s*(?:l)?essages?"
        r"[\s\-\u2014\u2013:]*"
        r"(?:[\s\S]{0,250}?(?:(?:Message|Lesson)\s+\d+|Preview)[\s\-\u2014\u2013]*[\"\u201c\u2018\u2019\u0027\|\.…]?\s*(?:The\s+|A\s+)?)?"
    ),
    # Visiting Teachers Messages (vol35 style, no apostrophe variant)
    "Visiting Teachers Messages: ": (
        r"(?:V|U|\()?(?:i|s|u)?s?iting\s+"
        r"(?:(?:T|S|C|l|SJ)(?:e|l|a|J)?(?:a|e|c)?(?:ch|l!|h)?(?:er)?s?|Seal!?\s*Hes?)\s*"
        r"['\u2019]?\s*"
    ...
    # Body has: EDITORIAL ... VOL. 35 MONTH 1948 NO. N <actual title>
    ...
    # Social Science (vol35 standalone — no lesson number required)
    "Social Science": (
        r"(?:Social\s+(?:Sc(?:i|t|l)ence|eicHiee|Stustiee|SCIENCE|ae|[A-Za-z]e))"
        r"[\s\-\u2014\u2013:@e]*"
    ),
    # Work Meeting Sewing (vol35 style)
    # Body format: "Work Meetings\nSewing (A Course...)\nLesson N—Title"
    "Work Meeting Sewing: ": (
        r"(?:W|V)ork\s+(?:IT|T|M)?(?:l)?(?:ee|ec)?tings?"
        r"[)\s\-\u2014\u2013:\n]*"
        r"(?:Sewing|SEWING)"
        r"[\s\S]{0,150}?"
        r"(?:(?:Lesson|Discussion)\s+[\d|]+|Preview)"
        r"[\s\-\u2014\u2013]*[\"\u201c\u2018\u2019\u0027]?"
    ),
    # Work Meeting (generic, for safety)
    "Work Meeting: ": (
        r"(?:W|V)ork\s+(?:IT|T|M)?(?:l)?(?:ee|ec)?ting"
        r"[)\s\-\u2014\u2013:]*"
        r"(?:[\s\S]{0,250}?(?:(?:Lesson|Discussion)\s+[\d|]+|Preview)[\s\-\u2014\u2013]*[\"\u201c\u2018\u2019\u0027]?)?"
    ),
    # Optional Lessons in Lieu of Social Science (vol35)
    "Optional Lessons in Lieu of Social Science: ": (
        r"(?:O|0)ptional\s+(?:L|l)essons?\s+(?:i|I)n\s+(?:L|l)ieu\s+of\s+"
        r"(?:Social\s+(?:Sc(?:i|t|l)ence|Science))"
        r"[\s\-\u2014\u2013:]*"
    ),
    ...
    "Notes from the Field: ": (
        r"(?:Notes?\s+)?(?:f|F|St|S)rom\s+(?:Th|Sh|Ch|th|t)e\s+(?:F|St|S)(?:i|e)?eld"
        r":?\s*"
    ),
    # Serial fiction: Questing Lights (Chapters 4-9, Jul-Dec 1948)
    "Questing Lights Chapter 4": _QUESTING_LIGHTS_PAT + r"(?:4|IV)\b",
    "Questing Lights Chapter 5": _QUESTING_LIGHTS_PAT + r"(?:5|V)\b",
    "Questing Lights Chapter 6": _QUESTING_LIGHTS_PAT + r"(?:6|VI)\b",
    "Questing Lights Chapter 7": _QUESTING_LIGHTS_PAT + r"(?:7|VII)\b",
    "Questing Lights Chapter 8": _QUESTING_LIGHTS_PAT + r"(?:8|VIII)\b",
    "Questing Lights Chapter 9 (Conclusion)": _QUESTING_LIGHTS_PAT + r"(?:(?:9|IX)\b|\(?\s*(?:C|c)onclusion\s*\)?)",
}
...
_LESSON_TITLE_PREFIXES = {
    ...
    "Visiting Teachers Messages: ", "Visiting Teachers\u2019 Messages: ",
    "Work Meeting Sewing: ", "Work Meeting Sewing",
    "Optional Lessons in Lieu of Social Science: ",
    "Social Science",
}
...
_LESSON_SECTION_HEADERS = [
    ...
    # Visiting Teacher(s) Messages (with or without apostrophe/s)
    re.compile(
        r'(?:V|U|\()?(?:i|s|u)?s?iting\s+'
        r'(?:(?:T|S|C|l|SJ)(?:e|l|a|J)?(?:a|e|c)?(?:ch|l!|h)?(?:er)?s?|Seal!?\s*Hes?)\s*'
        r"['\u2019]?\s*"
    ...
    # Work Meeting (including Work Meeting Sewing)
    re.compile(
    ...
    re.compile(
        r'(?:(?:Fo\s+i|S\s+i|O|Of?\s+i|of\s+i)?)?'
        r'[Ll]?iterature[\s\u2014\u2013\-:]+'
        r'(?:America|Come|Expand|Lesson|Cosmopolitan|Doctrinal|Appreciation|Highlights|Gospel|Words|Literature)',
        re.IGNORECASE
    ),
    ...
    # Optional Lessons in Lieu of Social Science (vol35)
    re.compile(
        r'(?:O|0)ptional\s+Lessons?\s+in\s+Lieu\s+of\s+Social\s+Science',
        re.IGNORECASE
    ),
]
...
def main():
    parser = argparse.ArgumentParser(
        description="Extract Relief Society Magazine Vol 35 into individual entries"
    )
    ...
    vol35_out = OUTPUT_DIR / "vol35"
    if vol35_out.exists() and not args.dry_run:
        print(f"Cleaning output directory: {vol35_out}")
        shutil.rmtree(vol35_out)
    ...
    for (vol, issue_key), entries in VOL35_TOC.items():
